...
RecyclerView rc;
    ...
    class call extends AsyncTask<Void,Void, ArrayList<String>>
       ...
       public void onPreExecute() {
        ...
        public ArrayList<String> doInBackground(Void... voids) {
            ...
            while(c.moveToNext()){
                ...
                //   String b=String.valueOf(c.getColumnIndex(CallLog.Calls.CACHED_NAME));
                boj.add(a);
